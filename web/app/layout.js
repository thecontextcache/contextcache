      ...
      <head>
        <script
          dangerouslySetInnerHTML={{
            __html: `(function(){try{var t=localStorage.getItem('contextcache_theme')||'dark';if(t!=='dark'&&t!=='light'&&t!=='system')t='dark';var r=t==='system'?(matchMedia('(prefers-color-scheme:dark)').matches?'dark':'light'):t;document.documentElement.setAttribute('data-theme',r)}catch(e){}})()`,
          }}
        />
