...
class RawCapture(Base):
    ...
    __table_args__ = (
        UniqueConstraint("org_id", "idempotency_key", name="uq_raw_captures_org_idempotency"),
        Index("ix_raw_captures_org_status_captured", "org_id", "processing_status", "captured_at"),
    )
